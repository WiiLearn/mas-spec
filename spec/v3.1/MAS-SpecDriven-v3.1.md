# MAS v3.1 Part 11: Spec-Driven Artifact Generation

**Status:** Draft Specification  
**Version:** 3.1.0  
**Date:** 2025-12-04  
**Parent:** [MAS v3.0 Index](../v3.0/MAS-v3.0-INDEX.md)  
**Industry References:**
...
This specification defines a **Spec-Driven Artifact Generation** system that bridges structured specification documents
with MAS visual artifacts. It enables:
...
MAS Compiler extends spec-driven development by **automatically generating visual artifacts** from specification
documents:
...
Example App collaborative workspace with AI-powered features.
...
// .kiro/settings/mcp.json
{
  "mcpServers": {
    "mas-compiler": {
      ...
      "args": [
        "-m",
        "quivr_api.apps.mas_compiler.mcp_server.run_mcp"
      ],
      "env": {
...
- [MAS v2.6 Index](../spec/v2.6/MAS-v2.6-INDEX.md)
- [MAS v3.0 Index](../v3.0/MAS-v3.0-INDEX.md)
- [MAS ASCII Wireframe v2.6](../spec/v2.6/MAS-ASCIIWireframe-v2.6.md)
- [MAS UX Diagrams v2.5](../spec/v2.5/MAS-UXDiagrams-v2.5.md)
- [MAS Business Operations v2.5](../spec/v2.5/MAS-BusinessOperations-v2.5.md)
...
- **3.1.0** (2025-12-04): Added OpenSpec compatibility (delta management, scenario blocks, AGENTS.md, multi-tool
  support)
